...
LogisticBifurcation.plot_over_variable('r', [2.5, 3.98], 0.01, initial_x=0.5)
...
def CubicMap(x, *, r=0.9, a=1):
        return r * x ** 3 + x * (1 - r)*a
...
CubicBifurcation =  Map1D(CubicMap, [1,4], [-1,1], 1000, dF_args={'r':0.9, 'a':1}, thermalization=100, Title='Cubic Map')
CubicBifurcation.plot_over_variable('r', [1.,4.], 0.01, initial_x=0.4)
CubicBifurcation.add_slider('a', valinterval=[0,1], valstep=0.05)
...
SingerBifurcation.plot_over_variable('r', [0.9,1.075], 0.0001, initial_x=0.4)
...
Logistic2Bifurcation.plot_over_variable('r', [2.5, 3.98], 0.001, initial_x=0.5)
