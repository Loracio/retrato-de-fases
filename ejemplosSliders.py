...
RetratoPolares = RetratoDeFases2D(dFPolares, [-3, 3], dF_args={'μ':0.5, 'η':0},Polar=True, Titulo='Ciclo Límite')
...
RetratoLoveAffairs = RetratoDeFases2D(dFLoveAffairs, [-3, 3], dF_args={'a':1, 'b':0, 'c':-1, 'd':1}, Densidad=1.5, Titulo='Love Affairs', xlabel='R', ylabel='J')
...
RetratoCentroNoLineal = RetratoDeFases2D(dFCentroNoLineal, [-2,2], dF_args={'a':1, 'b':1, 'c':1, 'd':1}, Densidad=2, Titulo='Centro no lineal en (0,0)', xlabel='X', ylabel='Y')
