...
RetratoPolares = rdf.RetratoDeFases2D(dFPolares, [-3, 3], Polar=True, Titulo='Ciclo Límite')
...
RetratoLoveAffairs = rdf.RetratoDeFases2D(dFLoveAffairs, [-3, 3], Densidad=1.5, Titulo='Love Affairs', xlabel='R', ylabel='J')
...
RetratoCentroNoLineal = rdf.RetratoDeFases2D(dFCentroNoLineal, [-2,2], Densidad=2, Titulo='Centro no lineal en (0,0)', xlabel='X', ylabel='Y')
