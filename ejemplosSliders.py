...
RetratoPolares = RetratoDeFases2D(dFPolares, [-3, 3], Polar=True, Titulo='Ciclo Límite', Densidad=1)
...
RetratoLoveAffairs = RetratoDeFases2D(dFLoveAffairs, [-3, 3], Densidad=1, Titulo='Love Affairs', xlabel='R', ylabel='J')
